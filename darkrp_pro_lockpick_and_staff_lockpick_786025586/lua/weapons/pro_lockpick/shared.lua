...
if CLIENT then
	...
	SWEP.Icon = "vgui/weapons/pro_lockpick"
end

if SERVER then
	resource.AddFile('materials/vgui/weapons/pro_lockpick.vmt')
end
...
SWEP.Contact = ""
SWEP.Purpose = "A faster version of the default DarkRP lockpick."
...
function SWEP:PrimaryAttack()
    ...
    self:SetLockpickEndTime(CurTime() + endDelta / 2.5)
