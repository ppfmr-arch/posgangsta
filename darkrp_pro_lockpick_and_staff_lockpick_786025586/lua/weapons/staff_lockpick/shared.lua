...
if CLIENT then
    SWEP.PrintName = "Staff Lockpick"
    SWEP.Slot = 5
    SWEP.SlotPos = 1
    SWEP.DrawAmmo = false
    SWEP.DrawCrosshair = false
	SWEP.Icon = "vgui/weapons/staff_lockpick"
end

if SERVER then
	resource.AddFile('materials/vgui/weapons/staff_lockpick.vmt')
end

-- Variables that are used on both client and server
-- All of this code still belongs to the original creator, I just editted the time values to make it faster.
SWEP.Author = "coltonk9043"
SWEP.Instructions = "Left or right click to pick a lock"
SWEP.Contact = ""
SWEP.Purpose = "Used by staff to check if something is lockpickable."
...
function SWEP:PrimaryAttack()
    ...
    self:SetLockpickEndTime(CurTime())
